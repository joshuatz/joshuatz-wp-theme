...
<?php
    ...
    $featuredImageHasShadow = $jtzwpHelpers->featuredImageHasShadow($postId);
    $hasExcerpt = has_excerpt();
    $permalink = $jtzwpHelpers->getPostPermalink($postId);
...
<div id="<?php echo $postTypeSingular . get_the_ID(); ?>" class="genericPostItem <?php echo implode(' ',get_post_class()); ?>">
    ...
    <div class="row">
        <div class="col s12 center">
            <a href="<?php echo $permalink; ?>" target="<?php echo $linkTarget; ?>"><h3><?php echo get_the_title(); ?></h3></a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <?php if($hasFeaturedImage): ?>
            <div class="col s12 m6 xl5 center">
                <a href="<?php echo $permalink; ?>" target="<?php echo $linkTarget; ?>" class="featuredImageWrapperLink">
        ...
        <div class="col <?php echo ($hasFeaturedImage ? 's2 offset-s1' : 's2 offset-s2'); ?>">
            <a class="btn waves-effect readMore jtzwp-dark" href="<?php echo $permalink; ?>">

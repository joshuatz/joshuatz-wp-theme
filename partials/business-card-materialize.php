 ...
 */
    ...
    $stackoverflowUrl = $jtzwpHelpers->getThemeUserSetting('jtzwp_about_me_stackoverflow_url');
            ...
            <div class="col s12 m8 leftSide">
                ...
                <div class="row">
                    <div class="col s11 offset-s1 linksAndDetailsSection">
                        ...
                        <?php endif; ?>
                        <?php if ($stackoverflowUrl->isValid): ?>
                            <div class="rowJoinerWrapper"><div class="rowJoiner iconsSolidBackground"></div></div>
                            <div class="linkedInURL col s12 valign-wrapper">
                                <div class="iconWrapper z-depth-2 iconsSolidBackground">
                                    <div class="icon">
                                        <i class="material-icons left">question_answer</i><i class="fa fa-stack-overflow iconsSolidBackground" aria-hidden="true"></i>
                                    </div>
                                </div>
                                <div class="textWrapper">
                                    <a href="<?php echo $stackoverflowUrl->val; ?>" target="_blank">Stack Overflow</a>
                                </div>
                            </div>
                        <?php endif; ?>
